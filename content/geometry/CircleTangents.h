 ...
 * 1 if the circles are tangent to each other (in which case .fst = .snd and the tangent line is perpendicular to the line between the centers).
 * .fst and .snd give the tangency points at circle 1 and 2 respectively.
